...
const links = [
  ...
  { title: "Privacy Policy", href: "/privacy-policy", id: 1 },
  { title: "Terms & Conditions", href: "/terms-conditions", id: 6 },
    ...
    <footer className="py-16 md:py-32 bg-background border-t border-border">
      <div className="mx-auto max-w-5xl px-6">
        ...
        <span className="text-muted-foreground block text-center text-sm">
          {" "}
          © {new Date().getFullYear()} Ethnic Elegance, All rights reserved
        </span>
      </div>
    </footer>
  );
